...
const Repo = ({repo}) => {
    ...
    const handleclick = async(repo)=>{
        try {
            ...
            toast.success("Cloning Repo successfull")
        } catch (error) {
	...
	return (
		<li className='mb-10 ms-7'>
			...
			<time
			 ...
			 text-gray-400'
			>
				Coded on {formattedDate}
			</time>
			<p className='mb-4 text-base font-normal text-gray-500'>{repo.description ? repo.description.slice(0,500) : "No description found for the repo"}</p>
